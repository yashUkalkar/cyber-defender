...
class L2Page11 extends StatelessWidget {
  @override
      ...
      body: Container(
        ...
        decoration: BoxDecoration(
          image: DecorationImage(
            image:
                AssetImage('assets/images/story/8to11/level1/Level2Page11.png'),
            fit: BoxFit.cover,
          ),
        ),
        child: ListView(
            ...
            SafeArea(
              ...
              child: Column(
                children: <Widget>[
                  GestureDetector(
                    onTap: () {
                      AudioPlayer(playerId: "sus_music").stop();
                      Navigator.pushAndRemoveUntil(
                        context,
                        PageRouteBuilder(
                          pageBuilder: (c, a1, a2) => StartScreen(),
                            ...
                            child: Column(
                              children: [
                                ...
                                Container(
                                  alignment: Alignment.center,
                                  child: Text(
                                    "\nAlways contact for help when needed",
                                    style: TextStyle(
                                        fontSize: 15,
                                        fontWeight: FontWeight.w600),
                                  ),
